...
function cerrar(x) {
    ...
    Loader { x: 5; y: 24; height: parent.height -30; id: carga; width: maxi(2) -6
    ...
    BorderImage {
          ...
          border { left: 5; top: 24; right: 6; bottom: 6 }
...
ParallelAnimation {
    ...
    NumberAnimation {target: anima; properties: "opacity"; from: 0.0; to: 1.0; duration: 300}
          ...
          Image { //Cerrar Aplicacion
             x: parent.width -22; y: 6; z: parent.z + 1
        ...
        Image { //Maximizar Aplicacion
             x: parent.width -40; y: 6; z: parent.z + 1
        ...
        Image { //Minimizar
             x: parent.width -56; y: 6; z: parent.z + 1
