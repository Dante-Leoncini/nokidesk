...
function cerrar(x) {
    ...
    Loader { x: 4; y: 28; height: parent.height -32; id: carga; width: maxi(2) -8
    ...
    BorderImage {
          ...
          border { left: 28; top: 29; right: 35; bottom: 4 }
...
ParallelAnimation {
    ...
    NumberAnimation {target: anima; properties: "opacity"; from: 0.0; to: 1.0; duration: 300}
          ...
          Image { //Cerrar Aplicacion
             x: parent.width -26; y: 5; z: parent.z + 1
        ...
        Image { //Maximizar Aplicacion
             x: parent.width -49; y: 5; z: parent.z + 1
        ...
        Image { //Minimizar
             x: parent.width -72; y: 5; z: parent.z + 1
