...
else if (x == 1 && aplicaciones.get(cerrar(indice)-1).maximizado == true) {return screenHeight -24}

else if (x == 2 && aplicaciones.get(cerrar(indice)-1).maximizado == false) {return aplicaciones.get(cerrar(indice)-1).ancho}

else if (x == 2 && aplicaciones.get(cerrar(indice)-1).maximizado == true) {return screenWidth +16}
...
function cerrar(x) {
    ...
    Item { x: 8; y: 30; height: parent.height -38; width: maxi(2)
...
//"alto: " + aplicaciones.get(cerrar(indice)-1).alto + " screenHeight: " + screenHeight + " maximizado: " + aplicaciones.get(cerrar(indice)-1).maximizado
